...
public class Towords extends JRDefaultScriptlet {
  ...
  public static String convertToIndianCurrency(double num)
  {
    ...
    String paise = decimal > 0 ? " And Paise " + (String)words.get(Integer.valueOf(decimal - decimal % 10)) + " " + (String)words.get(Integer.valueOf(decimal % 10)) : "";
